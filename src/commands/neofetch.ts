...
<span class="tc-cyan omarchy-icon">&#xe900;</span> ${click('Omarchy', 'cat projects/omarchy', 'tc-link-inline')} (core contributor)
...
<span class="tc-cyan"> 8 8888.   ,88'     8 8888        8 </span>   <span class="tc-cyan omarchy-icon">&#xe900;</span> ${click('Omarchy', 'cat projects/omarchy', 'tc-link-inline')} (core contributor)
