...
<span class="tc-cyan omarchy-icon">&#xe900;</span> ${click('Omarchy', 'cat projects/omarchy', 'tc-link-inline')} (core team)
...
<span class="tc-cyan"> 8 8888     ,88     8 8888        8 </span>   <span class="tc-cyan omarchy-icon">&#xe900;</span> ${click('Omarchy', 'cat projects/omarchy', 'tc-link-inline')} (core team)
<span class="tc-cyan"> 8 8888.   ,88'     8 8888        8 </span>   <span class="tc-cyan nf">&#xf015;</span> ${click('Sunset Villas', 'cat projects/sunset-villas', 'tc-link-inline')} (co-owner)
<span class="tc-cyan"> 8 888888888P'      8 8888        8 </span>   <span class="tc-muted">─── Stack ───</span>
<span class="tc-cyan"> 8 8888\`8b          8 8888888888888 </span>   <span class="tc-cyan nf">&#xf0c2;</span> Cloudflare, Google
<span class="tc-cyan"> 8 8888 \`8b.        8 8888        8 </span>   <span class="tc-cyan nf">&#xf121;</span> Ruby on Rails, Astro, Bash
<span class="tc-cyan"> 8 8888   \`8b.      8 8888        8 </span>   <span class="tc-cyan nf">&#xf085;</span> AI/ML enthusiast
<span class="tc-cyan"> 8 8888    \`88.     8 8888        8 </span>   <span class="tc-muted">─── Personal ───</span>
                                       <span class="tc-cyan nf">&#xf1b0;</span> ${click('Remus', 'cat about/dogs/remus', 'tc-link-inline')} + ${click('Arthas José', 'cat about/dogs/arthas', 'tc-link-inline')}
                                       <span class="tc-cyan nf">&#xf1fc;</span> Tokyo Night <span style="color:#f7768e">●</span><span style="color:#ff9e64">●</span><span style="color:#e0af68">●</span><span style="color:#9ece6a">●</span><span style="color:#7dcfff">●</span><span style="color:#7aa2f7">●</span><span style="color:#bb9af7">●</span><span style="color:#c0caf5">●</span>`;
}
