...
<span class="tc-cyan nf">&#xf0e7;</span> ${click('Herald', 'cat projects/herald', 'tc-link-inline')} (founder)
...
<span class="tc-cyan"> 8 8888     ,88     8 8888        8 </span>   <span class="tc-cyan nf">&#xf0e7;</span> ${click('Herald', 'cat projects/herald', 'tc-link-inline')} (founder)
